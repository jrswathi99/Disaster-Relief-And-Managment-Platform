 ...
 * @author DELL
 */
public class RescueOfficerJPanel extends javax.swing.JPanel {
     ...
     */
    public RescueOfficerJPanel(JPanel userProcessContainer,RescueOfficer rescueOfficer,DisasterCoordinator disasterCoordinator, RescueResourceManager rescueResourceManager ) {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Rescue Manager  Work Area");
    ...
    rescueOfficer.addResource(rescueResourceManager, resourceType, quantity);
    ...
    boolean success = rescueOfficer.fulfillRequest(rescueResourceManager, requestId, quantity);
    if (success) {
    ...
    private void fulfillRequest() {
        ...
        String requestId = (String) tblRequests.getValueAt(selectedRow, 0);
        int quantity = (int) tblRequests.getValueAt(selectedRow, 2);
        rescueOfficer.fulfillRequest(rescueResourceManager, requestId, quantity);
        populateRequestsTable();
        populateResourcesTable();
    }
    ...
    private void populateResourcesTable() {
        ...
        for (String resourceType : rescueResourceManager.listAvailableResources().keySet()) {
            model.addRow(new Object[]{resourceType, rescueResourceManager.getAvailableQuantity(resourceType)});
        }
    }
    ...
    private void populateRequestsTable() {
        ...
        model.setRowCount(0);
        for (ResourceRequest request : rescueResourceManager.getAllRequests()) {
